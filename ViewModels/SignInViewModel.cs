    ...
    class SignInViewModel : INavigatable<AuthNavigationTypes>, INotifyPropertyChanged
    {
        ...
        private async void SignIn()
        {
            ...
            else
            {
                ...
                MessageBox.Show($"Sign In was successful for user {user.Name} {user.LastName}");
        ...
        {
            return !String.IsNullOrWhiteSpace(_user.Name);// && !String.IsNullOrWhiteSpace(_user.Password);
        }
